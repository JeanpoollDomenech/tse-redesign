    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 flex items-center min-h-[360px]">
        <div className="max-w-2xl">
          <span className="inline-block text-blue-200 text-sm font-medium tracking-wide uppercase mb-3">
            {slide.eyebrow}
          </span>
          ...
          <a
            href={slide.href}
            className="inline-flex items-center gap-2 bg-white text-blue-700 font-semibold px-6 py-3 rounded-lg hover:bg-blue-50 transition-colors shadow-md text-sm"
          >
            {slide.cta}
        ...
        <div className="hidden lg:flex absolute right-12 top-1/2 -translate-y-1/2 flex-col items-center justify-center bg-white/10 border border-white/20 rounded-2xl p-6 backdrop-blur-sm">
          <span className="text-blue-200 text-xs font-semibold uppercase tracking-widest mb-1">
            Elecciones
          </span>
